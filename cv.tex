      ...
      \color{maintext}{
        ...
        \begin{itemize}
          ...
          \item \emph{École Normale Supérieure} in Paris:
                \begin{itemize}[topsep=0em]
                  \itemsep0em
                  \item \textbf{2016-2017} Computer science bachelor's degree
        ...
        \begin{itemize}
          ...
          \item \emph{\small (2024\dots)} \textbf{Railway safety engineer} \\
                ...
                \vspace{-7.5mm}\begin{itemize}
                  \item \small ERTMS security analyses (SNCF)\hfill\emph{3 mois}
                  \item \small CBTC functional specification (Alstom)\hfill\emph{15 mois}
                  \item \small KVB formalisation in Atelier B (Alstom)\hfill\emph{1 mois}
                \end{itemize}
        \end{itemize}
