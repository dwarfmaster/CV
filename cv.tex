...
\begin{minipage}[c]{0.35\linewidth}
    \begin{tcolorbox}[
        ...
        Programming, Type Theory, Proof Assistants, Abstract Interpretation,
        Formal Systems, Programming languages design, Operating systems,
        ...
        \vspace{0cm}
        \tcbsubtitle{\Large\bf OS Contributions}
        % \begin{itemize}[label=\textcolor{mainbg}{$\blacksquare$}]
        \begin{description}
          \setlength{\itemsep}{0em}
          \item[\href{https://github.com/imain/notmuch-vim}{notmuch-vim}]
          \item[\href{https://github.com/the-lambda-church/coquille}{coquille}]
          \item[\href{https://github.com/NixOS/nixpkgs}{Nixpkgs}]
          \item[\href{https://github.com/benoitc/gunicorn}{gunicorn}]
          \item[\href{https://github.com/nix-community/nixvim}{Nixvim}]
          \item[\href{https://github.com/danth/stylix}{Stylix}]
        \end{description}
